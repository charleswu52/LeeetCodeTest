...
/**
 * @author WuChao
 * @create 2021/11/15 上午9:28
 */
public class _15_319 {
    /**
     * 每日一题：2021/11/15
     * <p>
     * 319. 灯泡开关
    ...
    又根据「约数」的定义，我们知道如果某个数 k 为 x 的约数，那么 x / k  亦为 x 的约数，即「约数」总是成对出现，那么某个数的约数个数为奇数，
    意味着某个约数在分解过程中出现了 2 次，且必然重复出现在同一次拆解中，即 k = x / k ，即有 x 为完全平方数（反之亦然）。

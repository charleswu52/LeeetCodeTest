package graduate.publiclog.openssh;
 ...
 */
public class SplitOpenSSHLog2Json {
    ...
    public static void transform(String filePath, String outPath, String name) {
        ...
        try {
            ...
            while (csvReader.readRecord() && line <= size) {
                ...
                String value1 = "{\"index\":{\"_index\":\"" + "openssh_" + size + "\",\"_type\":\"_doc\",\"_id\":" + id + "}}\n";
                String value2 = "{\"date\":\"" + date + "\",\"day\":\"" + day + "\",\"time\":\"" + time + "\",\"component\":\"" + component + "\",\"pid\":\"" + pid + "\",\"content\":\"" + content + "\"}\n";
                // 写入文件

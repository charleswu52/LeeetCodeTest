...
public class SplitApacheLog2Json {
    ...
    public static void main(String[] args) throws Exception {
        String str = "apache";
        String filePath = "H:\\Work\\LogCompress\\logparser\\allresult\\Drain\\" + name + "\\" + name + ".log_structured.csv";
        String jsonOutPutPath = "H:\\Work\\LogCompress\\logparser\\allLogs2Json\\" + name + "\\" + size + "\\";
        String originOutPutPath = "H:\\Work\\LogCompress\\logsearch\\" + name + "\\" + size + "\\origin\\";

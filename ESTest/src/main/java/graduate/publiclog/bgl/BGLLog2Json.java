package graduate.publiclog.bgl;
    ...
    public static void transform(String filePath, String outPath, String name) {
        ...
        try {
            ...
            while (csvReader.readRecord()) {
                ...
                String nodeRepeat = csvReader.get("NodeRepeat");
                ...
                String value1 = "{\"index\":{\"_index\":\"" + "bgl" + "\",\"_type\":\"_doc\",\"_id\":" + id + "}}\n";
                String value2 = "{\"label\":\"" + label +
                        "\",\"timestamp\":\"" + timestamp +
                        "\",\"date\":\"" + date +
                        "\",\"node\":\"" + node +
                        "\",\"time\":\"" + time +

package graduate.publiclog.hpc;
...
/**
 * @author WuChao
 * @create 2022/3/19 上午8:38
 */
public class HPCLog2Json {
    // 将 HPC log 日志 转化为 导入到 ES中的JSON文件
    static final int count = 100000; // 10w条数据一个文件
    static String name = "HPC";
    ...
    public static void transform(String filePath, String outPath, String name) {
        ...
        try {
            ...
            while (csvReader.readRecord()) {
                ...
                String logid = csvReader.get("LogId");
                ...
                String flag = csvReader.get("Flag");
                String content = csvReader.get("Content");
                String value1 = "{\"index\":{\"_index\":\"" + "hpc" + "\",\"_type\":\"_doc\",\"_id\":" + id + "}}\n";
                String value2 = "{\"logid\":\"" + logid + "\",\"node\":\"" + node + "\",\"component\":\"" + component + "\",\"state\":\"" + state + "\",\"time\":\"" + time + "\",\"flag\":\"" + flag + "\",\"content\":\"" + content + "\"}\n";
                // 写入文件
